package com.pico.make_it_so.presentation.auth.log_in
...
import com.pico.make_it_so.presentation.auth.log_in.components.LoginTopAppBar
...
fun LoginScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            Button(onClick = { viewModel.onEvent(LoginEvent.Login(onSuccessLogin = {
                navigator.navigate(
